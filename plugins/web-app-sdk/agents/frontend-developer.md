...
Always begin by reviewing the project's CLAUDE.md and existing code. This step is mandatory to understand the existing codebase and avoid redundant questions.
...
Begin by reviewing the project's CLAUDE.md and existing code to map the existing frontend landscape. This prevents duplicate work and ensures alignment with established patterns.
...
- Keep a record of all created/modified files
...
- Get API contracts from backend-architect
- Provide test IDs to qa-expert
- Share metrics with performance-engineer
- Coordinate with websocket-engineer for real-time features
- Work with deployment-engineer on build configs
- Collaborate with code-reviewer on CSP policies
