...
1. Review the project's CLAUDE.md and existing code for issue symptoms and system information
...
- Help code-reviewer on security bugs
- Assist backend-architect on backend issues
