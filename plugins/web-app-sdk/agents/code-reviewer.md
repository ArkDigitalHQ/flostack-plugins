...
1. Review the project's CLAUDE.md and existing code for code review requirements and standards
...
- Collaborate with code-reviewer on vulnerabilities
- Work with backend-architect on design
- Guide debugger on issue patterns
- Help performance-engineer on bottlenecks
- Assist test-automator on test quality
- Partner with backend-architect on implementation
